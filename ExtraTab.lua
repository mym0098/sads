  ...
  function check_markdown(text) 
   ...
   ------- Message Content --------
	...
	if msg.content.text then
       print("["..msg.content.text.."]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
	   Message_Type = 'messageText'
    end
    if msg.content.caption then
       print("["..msg.content.caption.."]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
	   Message_Type = 'messageCaption'
    end
    if msg.content._ == "messageChatAddMembers" then
       print("[TG Serviece][Add Member]["..msg.chat_id.."][MEYS]")
        Message_Type = 'AddUserTG'
    end
    if msg.content._ == "messageChatJoinByLink" then
	   print("[TG Serviece][Join Member]["..msg.chat_id.."][MEYS]")
        Message_Type = 'JoinedByLinkTG'
    end
    if msg.content._ == "messageDocument" then
       print("[Document]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Document'
    end
    if msg.content._ == "messageSticker" then
       print("[Sticker]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Sticker'
    end
    if msg.content._ == "messageAudio" then
        print("[Audio]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Audio'
    end
    if msg.content._ == "messageVoice" then
        print("[Voice]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Voice'
    end
    if msg.content._ == "messageVideo" then
        print("[Video]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Video'
    end
    if msg.content._ == "messageAnimation" then
        print("[Animation]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Gif'
    end
    if msg.content._ == "messageLocation" then
        print("[Location]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Location'
    end
    if msg.content._ == "messageForwardedFromUser" then
        print("[ForwardedMessage]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'messageForwardedFromUser'
    end
    if msg.content._ == "messageContact" then
        print("[Contact]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Contact'
    end
    if not msg.reply_markup and msg.via_bot_user_id ~= 0 then
        print("[MarkDown or A Bot Message]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Markreed'
    end
    if msg.content.game then
        print("[Game]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Game'
    end
    if msg.content._ == "messagePhoto" then
	    print("[Photo]["..msg.sender_user_id.."]["..msg.chat_id.."][MEYS]")
        Message_Type = 'Photo'
    end
